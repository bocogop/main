...
public class TxCommitAnnotationAspect {
	...
	@Around(value = "@annotation(org.bocogop.shared.util.aop.BeforeCommit)", argNames = "pjp")
	...
	@Around(value = "@annotation(org.bocogop.shared.util.aop.AfterCommit)", argNames = "pjp")
