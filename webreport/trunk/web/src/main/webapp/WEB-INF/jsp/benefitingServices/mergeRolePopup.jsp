...
function initMergeRolePopup() {
	...
	var submitMergeRole = function() {
		...
		var msg = 'Please confirm you wish to perform the following merge operation:<p>'
			...
			+ '			<tr><td align="right">Voters:</td><td align="right">Active: ' + fromCounts[0] + '<br>Total: ' + fromCounts[1] + '</td></tr>'
			...
			+ '			<tr><td align="right">Voters:</td><td align="right">Active: ' + toCounts[0] + '<br>Total: ' + toCounts[1] + '</td></tr>'
