...
<div class="clearCenter" style="margin-bottom: 15px">
	<table>
		<tr>
			...
			<td><app:input
					path="precinct.stationParameters.voluntarySignatureLine"
		...
		<tr>
			...
			<td><app:input
					path="precinct.stationParameters.directorSignatureLine"
		...
		<tr>
			...
			<td><app:input path="precinct.stationParameters.valueAmount"
					id="valueAmount" class="currency" size="13" /> <app:errors
					path="precinct.stationParameters.valueAmount" cssClass="msg-error" /></td>
					</tr>
