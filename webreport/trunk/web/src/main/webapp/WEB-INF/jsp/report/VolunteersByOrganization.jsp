...
<script type="text/javascript">
	...
	setWidgetsInitializedCallback(function() {
		...
		var beginDateWidget = getWidget('beginDate')
		var endDateWidget = getWidget('endDate')
...
<div
	...
	<c:out value="Date range cannot exceed more than 12 months." />
...
<div
	style="display: inline-block; vertical-align: top; min-width: 400px; text-align: right">
	<div class="clearCenter" style="text-align: center">
		...
		<tiles:insertDefinition name="widgetOrganizationSelector">
			...
			<tiles:putAttribute name="includeNational" value="true"
				cascade="true" />
